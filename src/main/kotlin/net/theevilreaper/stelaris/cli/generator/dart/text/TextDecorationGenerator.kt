...
/**
 * Generator for the [TextDecoration] enum in Dart.
 * @author theEvilReaper
 * @version 1.0.0
 * @since 1.0.0
 */
@AutoService(Generator::class)
@CodeGenerator(name = "TextDecorationGenerator")
class TextDecorationGenerator : BaseGenerator(
    ...
    override fun generate(outputPath: Path) {
        ...
        val enumProperties = TextDecoration.entries
            .sortedBy { it.toString() }
            .map { decoration ->
                val rawName = decoration.toString()
        ...
        val enumFile = DartFile.builder("text_decoration")
